...
const { analyzeImage, generateAltText, extractImageKeywords, batchAnalyzeMedia } = require('../../lib/aiHelpers');
const fs = require('fs');
...
router.post('/api/media/bulk-update', isEditor, async (req, res) => {
    try {
        ...
        const allowedFields = ['category_id', 'alt_text', 'description', 'seo_alt', 'seo_description', 'meta_keywords'];
        const updateFields = [];
        const updateValues = [];
