/* Shared Accessibility Utilities (focus trap + dialog creation)
 * Provides lightweight focus trapping and ESC/Backdrop close behavior
 * Usage:
 *   const dlg = A11yDialog.create({ label:'Example', className:'my-dialog', html:'<div>...</div>' });
 *   dlg.on('close', ()=> console.log('closed'));
